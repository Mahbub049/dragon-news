    ...
    return (
        <div className="navbar bg-base-100">
            ...
            <div className="dropdown dropdown-end mr-3">
                ...
                {
                    user ? 
                    <Link to={'/'} onClick={handleSignOut} className="text-white text-xl font-semibold py-3 px-12 bg-[#403F3F]">Sign Out</Link>
                    :
                    <Link to={'/login'} className="text-white text-xl font-semibold py-3 px-12 bg-[#403F3F]">Login</Link>
                }
            </div>
            </div>
    );
